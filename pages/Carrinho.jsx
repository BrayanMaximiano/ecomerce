  ...
  return (
    <Container>
      ...
      <Wrapper>
        ...
        <Top>
          <TopButton><Link href='/'>CONTINUAR COMPRANDO</Link></TopButton>
          <TopTexts>
            <TopText>Sacola de compras(2)</TopText>
            <TopText>Sua lista de desejos (0)</TopText>
          </TopTexts>
          <TopButton type="filled" ><Link href='/'>FINALIZAR COMPRA</Link></TopButton>
        </Top>
        <Bottom>
          <Info>
            <Product>
              <ProductDetail>
                ...
                <Details>
                  <ProductName>
                    <b>Produto:</b> TENIS JESSIE THUNDER 
                  </ProductName>
                  <ProductId>
                    <b>ID:</b> 93813718293
                  </ProductId>
          ...
          <Summary>
            ...
            <SummaryItem>
              <SummaryItemText>Descontro do frete</SummaryItemText>
              <SummaryItemPrice>R$ -5,90</SummaryItemPrice>
            </SummaryItem>
            ...
            <Button><Link href='/'>FINALIZAR COMPRA</Link></Button>
          </Summary>
        </Bottom>
      </Wrapper>
      <Footer />
